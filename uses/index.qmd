...
title: What I use
date: 2023-05-04
description-meta: A list of the software, tools, and hardware José Caro uses for research, writing, and teaching
...
I try to keep this updated fairly regularly. As of May 30, 2024 this is what I'm using:


## Writing

- I permanently ditched Word as a writing environment in 2008 after starting grad school. I do all my writing in [LaTeX](https://www.latex-project.org/)[pandoc-flavored](http://pandoc.org/) and [Markdown](https://daringfireball.net/projects/markdown/) (including e-mails and paper-and-pencil writing)—it's incredibly intuitive, imminently readable, flexible, future proof, and lets me ignore formatting and focus on content.
...
- The key to my writing workflow is the magical [pandoc](http://pandoc.org/), which converts Markdown files into basically anything else. I follow a variation of Kieran Healy's [Plain Text Social Science workflow](http://plain-text.co/) to convert Markdown to HTML, PDF (through LaTeX), and Word (through LibreOffice).
...
- I post almost everything I write or develop on [GitHub](https://github.com/jrcarob).
...
- I run my main web server on a [DigitalOcean](https://www.digitalocean.com/) droplet, and I spin up temporary droplets to offload scraping scripts, complicated R models, and to create on-the-fly VPNs.
...
- Though I regularly use LaTeX (through pandoc), I adore [InDesign CC](https://www.adobe.com/products/indesign.html) and use it to make fancier academic and policy documents.
